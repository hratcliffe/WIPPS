...
\sin\theta \mathrm{d}\theta = \tan\theta \cos^3\theta \mathrm{d}\tan\theta= \frac{\tan\theta}{(\tan^2 \theta + 1)^{3/2}}\mathrm{d}\tan\theta = \frac{x}{(x^2+1)^{3/2}} f\mathrm{d}x
\end{equation}
...
\end{align}
Cancel the $V$ and subs the prefactors of $N$ from Eq \ref{N_om} so that 
\begin{equation} \label{N_prime} N(\omega) =: N^\prime(\omega) \frac{\omega^3}{(2\pi)^2 c^3}\end{equation}
\begin{align}
D_{\alpha\alpha}^{nk_\perp} &= \frac{\pi q^2}{m^2 v_\parallel} \left[ \frac{-\sin^2\alpha + n \Omega/\omega_k}{\cos \alpha}\right]^2 \frac{ |\Phi_{n,k}|^2}{\mu^2 |1-(\partial \omega_k/\partial k_\parallel)_x/v_\parallel|} \frac{1}{N^\prime(\omega)}B^2(\omega)g_\omega(\theta)\frac{ c^3}{\omega^3}
\end{align}
$\cos^2 \alpha$ can be replaced by $(v_\parallel/v)^2$

\begin{align}\label{LyMid}
D_{\alpha\alpha}^{nk_\perp} &= \frac{\pi q^2 v^2}{m^2 (v_\parallel/c)^3 \omega^3} \frac{1}{\mu^2} |\Phi_{n,k}|^2 \frac{ (-\sin^2\alpha + n \Omega/\omega_k)^2}{ |1-(\partial \omega_k/\partial k_\parallel)_x/v_\parallel|} \frac{1}{N^\prime(\omega)}B^2(\omega)g_\omega(\theta)
\end{align}

Tackle G1 and G2 next. Starting from Eq \ref{N_om} and Eq \ref{N_prime}
\begin{equation}
...
\begin{align}
G2_{denom} &= \int g_\omega(\theta^\prime) \mu^2 | \mu + \omega \partial\mu/\partial\omega| \sin \theta^\prime \mathrm{d} \theta^\prime\\
&=\int g_\omega(atan(x^\prime)) \mu^2 | \mu + \omega \partial\mu/\partial\omega|  \frac{x^\prime}{((x^\prime)^2 + 1)^{3/2}}\mathrm{d}x^\prime
\end{align}
i.e.
\begin{align}
...
\begin{align}\label{LyMid}
D_{\alpha\alpha}^{nk_\perp} &= \frac{\pi q^2 v^2}{m^2 (v_\parallel/c)^3 \omega^3} \frac{1}{\mu^2} |\Phi_{n,k}|^2 \frac{ (-\sin^2\alpha + n \Omega/\omega_k)^2}{ |1-(\partial \omega_k/\partial k_\parallel)_x/v_\parallel|} \frac{G_1}{\Delta \omega} B^2_{wave} \omega G_2
\end{align}
Recalling
\begin{align}
...
D_{\alpha\alpha}^{nk_\perp} &= \frac{\pi q^2 v^2}{m^2 (v_\parallel/c)^3}\frac{1}{c^2 k^2} |\Phi_{n,k}|^2 \frac{ (-\sin^2\alpha + n \Omega/\omega_k)^2}{ |1-(\partial \omega_k/\partial k_\parallel)_x/v_\parallel|} \frac{G_1}{\Delta \omega} B^2_{wave} G_2
\end{align}

Then  using $ \Omega_c = q B_0 / m_e c$ we find

\begin{align}\label{LyMid3}
D_{\alpha\alpha}^{nk_\perp} &= \frac{B^2_{wave}}{B_0^2} \frac{\pi v^2 \Omega_c^2}{\Delta \omega(v_\parallel/c)^3}\frac{1}{ k^2} |\Phi_{n,k}|^2 \frac{ (-\sin^2\alpha + n \Omega/\omega_k)^2}{ |1-(\partial \omega_k/\partial k_\parallel)_x/v_\parallel|} G_1 G_2
\end{align}
...
\end{equation}
and we must multiply the Lyons result by $k_\perp/x dk_\perp/dx$. $dk_\perp/dx = k (x^2+1)^{-3/2}$ and so
...
D_{\alpha\alpha}^{nx} &= \frac{B^2_{wave}}{B_0^2} \pi v^2 \frac{ \Omega_c^2 }{\Delta \omega}\frac{\cos^4\theta}{(v_\parallel/c)^3} |\Phi_{n,k}|^2 \frac{ (-\sin^2\alpha + n \Omega/\omega_k)^2}{ |1-(\partial \omega_k/\partial k_\parallel)_x/v_\parallel|} G_1 G_2
\end{align}

NB NB NB we have some erroneous $m^2$ and a $cos^4$ instead of 2
