...
/********Dispersion solvers ****/
  ...
  mu_dmudom get_phi_mu_om(calc_type w, calc_type psi, calc_type alpha, int n, bool Righthand=true)const;
  mu_dmudom get_high_dens_phi_mu_om(calc_type w, calc_type psi, calc_type alpha, int n, bool Righthand=true)const;
